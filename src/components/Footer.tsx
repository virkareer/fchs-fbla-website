        ...
        <footer className="bg-gray-900 text-white mt-auto">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        <h3 className="text-xl font-bold mb-4 text-[var(--color-fbla-accent)]">FCHS FBLA</h3>
                    ...
                    <div>
                        <h3 className="text-xl font-bold mb-4 text-[var(--color-fbla-accent)]">Advisor Contact</h3>
                        <div className="space-y-2 text-sm text-gray-300">
                            <p className="font-bold">Lex Alexander</p>
                            <div className="flex items-center space-x-2">
                                <Mail size={16} className="text-[var(--color-fbla-accent)]" />
                    ...
                    <div>
                        <h3 className="text-xl font-bold mb-4 text-[var(--color-fbla-accent)]">Links & Communications</h3>
